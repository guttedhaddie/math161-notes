...
\begin{proof}
	...
	\begin{minipage}[t]{0.65\linewidth}\vspace{-6pt}
		Extend $\cl{CB}$ to $E$, on the opposite side of $\lin{AB}$ to $C$, such that $\cl{BE}\cong\cl{DA}$.\smallbreak
...
\begin{exercises}
	\hangindent\leftmargini\emph{Key concepts: \ Absolute Geometry, \ $\Sigma_{\triangle}\le\ang{180}$, \ Saccheri \& Lambert quadrilaterals}\medbreak
	...
	\begin{enumerate}
		...
		\item (Hard)\lstsp Suppose two Saccheri quadrilaterals have congruent summits and  congruent perpendicular sides. Prove that the quadrilaterals are congruent.
	\end{enumerate}
\end{exercises}
...
\begin{defn}{}{poincaredisk2}
	...
	The \emph{hyperbolic circle} with center $P$ and (hyperbolic) radius $\rho$ is now easily defined as the set of points $X$ for which $d(X,Q)=\rho$. 
\end{defn}
