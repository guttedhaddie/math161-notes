...
\begin{defn}{}{hypdist2}
	...
	\hfill\includegraphics[scale=0.95]{isom-dist}
\end{defn}
...
\begin{example}{}{}
	...
	\begin{minipage}[t]{0.32\linewidth}\vspace{-2pt}
		\hfill\includegraphics[scale=0.95]{calc-triangle}
	\end{minipage}
\end{example}
...
\begin{minipage}[t]{0.24\linewidth}\vspace{-3pt}
	\hfill\includegraphics[scale=0.95]{isom-trans}\\
...
\begin{minipage}[t]{0.3\linewidth}\vspace{0pt}
	\hfill\includegraphics[scale=0.9]{isom-right}
\end{minipage}\par
...
\begin{examples}{}{hypbasictrig}
	...
	\begin{enumerate}\setcounter{enumi}{1}
	  ...
	  \hfill
	  \begin{minipage}[t]{0.39\linewidth}\vspace{-12pt}
	  	\hfill\includegraphics[scale=0.95]{isom-lambert}
	  \end{minipage}\par
...
\begin{cor}{Sine/Cosine rules and the Cosh-distance formula}{hypcossinerule}
	...
	\begin{description}
		...
		%\hfill
		%\begin{minipage}[t]{0.25\linewidth}\vspace{-15pt}
			\hfill\includegraphics[scale=0.95]{isom-sine}
		%\end{minipage}\par
...
\begin{examples}{}{hyptrig}
	...
	\begin{enumerate}\setcounter{enumi}{1}
	  ...
	  %\begin{minipage}[t]{0.3\linewidth}\vspace{-27pt}
	  	\hfill\includegraphics[scale=0.95]{isom-trigsas}
	  %\end{minipage}
	 ...
	 % \end{minipage}
	  ...
	  %\begin{minipage}[t]{0.34\linewidth}\vspace{-8pt}
	  	\hfill\includegraphics[scale=0.95]{isom-trigequil}
	  %\end{minipage}
	  ...
	  \begin{minipage}[t]{0.28\linewidth}\vspace{-20pt}
	  	\hfill\includegraphics[scale=0.95]{isom-right2}
	  ...
	  \begin{minipage}[t]{0.34\linewidth}\vspace{-12pt}
	  	\hfill\includegraphics[scale=0.95]{isom-trigasa}
	  \end{minipage}\par
...
\subsubsection*{Hyperbolic Tilings (just for fun!)}\phantomsection\label{pg:hyptiling}
...
\hfill
\begin{minipage}[t]{0.3\linewidth}\vspace{0pt}
	\hfill\includegraphics[scale=0.9]{isom-arclength}
\end{minipage}
\medbreak
