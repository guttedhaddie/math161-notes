...
While our \emph{arguments} for the above are false in absolute geometry, we cannot instantly claim that the \emph{results} are also; there might be alternative proofs! To see that these results truly require unique parallels, we must exhibit a \emph{model} of absolute geometry in which they are false.\footnote{
...
Developing such a model is the primary purpose of this chapter. Its existence explains why Saccheri and Lambert failed in their endeavors: the parallel postulate (Playfair) is indeed independent of Euclid's (Hilbert's) other axioms.
...
\begin{minipage}[t]{0.57\linewidth}\vspace{-8pt}
	...
	Suppose $\triangle ABC$ has angle sum $\Sigma_{\triangle}$ and construct $M$ and $E$ following Euclid. Observe:
\end{minipage}
\hfill
...
\begin{enumerate}
  ...
  \item $\mathcolor{mMagenta}{\measuredangle ACB} +\mathcolor{Brown}{\measuredangle CAB} =\mathcolor{mMagenta}{\measuredangle ACB} +\mathcolor{Brown}{\measuredangle ACE}<\ang{180}$ is the exterior angle theorem. More generally, the exterior angle theorem guarantees that the \emph{sum of any two angles in a triangle is strictly less than \ang{180}}.
  
  \item $\triangle ABC$ and $\triangle EBC$ have the \emph{same angle sum}---just look at the picture!
  \[
  	\Sigma_{\triangle}=\lgbullet{Brown} +\lgbullet{mGreen} +\lgbullet{BlueViolet} +\lgbullet{mMagenta}
  \]
  Remember that we do not know whether $\Sigma_{\triangle}=\ang{180}$!
  
  \item $\triangle EBC$ has at least one angle ($\mathcolor{BlueViolet}{\measuredangle EBC}$ or $\mathcolor{mGreen}{\measuredangle BEC}$) measuring $\le\frac 12\measuredangle ABC$.
\end{enumerate}

Iterate this construction: if $\mathcolor{BlueViolet}{\measuredangle EBC}\le\frac 12\measuredangle ABC$, start by bisecting $\cl{CE}$; otherwise bisect $\cl{BC}\ldots$.\par
...
\begin{enumeratea}
  ...
  \item The $n\th$ triangle $\triangle_n$ has at least one angle measuring $\alpha_n\le\frac 1{2^n}\measuredangle ABC$.
\end{enumeratea} 
...
\[
	n>\log_2\frac{\measuredangle ABC}{\epsilon} \implies \alpha_n<\epsilon
\]
But then the sum of the \emph{other two} angles in $\triangle_n$ would be \emph{greater than} \ang{180}, contradicting the exterior angle theorem (observation 1)! We have now proved a famous result.
...
\begin{defn}{}{}
	A \emph{Lambert quadrilateral} $AMND$ has three right-angles.\par
	\begin{minipage}[t]{0.6\linewidth}\vspace{0pt}
		...
		The interior angles at $C$ and $D$ are the \emph{summit angles.}
	\end{minipage}
	\hfill
...
We draw these with curved sides to indicate that the summit angles need not be right-angles, though we haven't yet exhibited a model which shows they could be anything else. Regardless of how they are drawn, $\cl{AD}$, $\cl{BC}$ and $\cl{CD}$ are all \emph{segments}!%\smallbreak
%The apparent symmetry of a Saccheri quadrilateral is not an illusion.

\begin{lemm}{}{saccheribasic}
	Saccheri and Lambert quadrilaterals exhibit basic symmetry.\par
	\begin{minipage}[t]{0.64\linewidth}\vspace{0pt}
		\begin{enumerate}
	  	...
	  	\item The summit angles of a Saccheri quadrilateral are congruent.
			\item In Euclidean geometry, Saccheri and Lambert quadrilaterals are rectangles (four right-angles, opposite sides congruent).
		\end{enumerate}
	\end{minipage}
	\hfill
	\begin{minipage}[t]{0.35\linewidth}\vspace{0pt}
...
\begin{proof}
	...
	\begin{minipage}[t]{0.34\linewidth}\vspace{-22pt}
		\hfill\includegraphics[scale=0.9]{history-quad2}\vspace{-5pt}
	\end{minipage}\par
...
\begin{exercises}
	Work in absolute geometry; you cannot use Playfair's Axiom or the parallel postulate!\par
		...
		\begin{minipage}[t]{0.32\linewidth}\vspace{-8pt}
			\hfill\includegraphics[scale=0.9]{history-saccheri2}\\
...
\begin{defn}{}{poincaredisk}
	...
	\hfill\includegraphics{models-parallels}
\end{defn}
...
\begin{lemm}{}{hypline}
	...
	\hfill\includegraphics[scale=0.95]{models-example}
\end{lemm}
...
\begin{defn*}{\ref{defn:poincaredisk} continued}
	...
	\begin{minipage}[t]{0.29\linewidth}\vspace{-5pt}
		\hfill\includegraphics{models-angle}
	\end{minipage}
\end{defn*}
...
\begin{example}{}{hypisosceles}
	...
	\begin{minipage}[t]{0.3\linewidth}\vspace{-20pt}
		\hfill\includegraphics[scale=0.9]{models-dist4}
	\end{minipage}
...
\hfill\includegraphics[scale=0.95]{hyper-circle}
...
\paragraph{Klein Disk Model} This is similar to the Poincaré disk, though lines are chords of the unit circle (`Euclidean' straight lines!) and the distance function is different:
\[
	d_K(P,Q) =\frac 12\nm{\ln\frac{\nm{P\Theta}\nm{Q\Omega}}{\nm{P\Omega}\nm{Q\Theta}}}
\]
...
\begin{minipage}[t]{0.3\linewidth}\vspace{-32pt}
	\hfill\includegraphics[scale=0.9]{models-klein}
\end{minipage}\medbreak
...
\begin{minipage}[t]{0.3\linewidth}\vspace{0pt}
	\hfill\includegraphics{models-halfplane}
\end{minipage}
...
\begin{minipage}[t]{0.39\linewidth}\vspace{0pt}
	\hfill\href{http://www.math.uci.edu/~ndonalds/math161/hyper-plane.html}{\includegraphics[scale=0.8]{hyper-plane}}
\end{minipage}
...
% \begin{minipage}[t]{0.3\linewidth}\vspace{-28pt}
	\hfill\includegraphics[scale=0.75]{basic-perp}
% \end{minipage}
...
\begin{thm}{Fundamental Theorem of Parallels}{hyperfund}
	...
	\hfill\includegraphics[scale=0.8]{basic-parallels}
\end{thm}
...
\begin{proof}
	...
	\begin{minipage}[t]{0.28\linewidth}\vspace{-8pt}
		\hfill\includegraphics[scale=1]{basic-parallels5}
	\end{minipage}
	\smallbreak
...
% 		\begin{minipage}[t]{0.29\linewidth}\vspace{-25pt}
		  \hfill\includegraphics[scale=0.95]{basic-parallels4}
...
% 		\begin{minipage}[t]{0.31\linewidth}\vspace{0pt}
			\hfill\includegraphics[scale=0.95]{basic-parallels3}
% 		\end{minipage}\smallbreak
...
% 	    \end{minipage}
	  ...
	  \begin{minipage}[t]{0.39\linewidth}\vspace{-5pt}
	   \hfill\includegraphics[scale=0.95]{basic-aaa}
	  \end{minipage}\medbreak
...
% \begin{minipage}[t]{0.28\linewidth}\vspace{-5pt}
	\hfill\includegraphics{omega-example}
% \end{minipage}\smallbreak
...
% 	If $r$ intersected $\ray{A\Omega}$ we have a (finite) triangle which would force (ASA) $\triangle AB\Omega$ to be finite. If $r$ intersected $\ray{B\Omega}$ we'd have a triangle contradicting the Exterior Angle Theorem. 
	...
	\begin{minipage}[t]{0.29\linewidth}\vspace{0pt}
		\hfill\includegraphics{basic-ext5}
	\end{minipage}\par
	\begin{itemize}
...
\begin{proof}
	We show that the two other cases are impossible.
	\begin{description}
	...
	\hfill\includegraphics[scale=0.95]{basic-ext4}\\\hfil\qedsymbol
\end{proof}
