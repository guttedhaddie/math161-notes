...
% \hfill
% \begin{minipage}[t]{0.25\linewidth}\vspace{-15pt}
	\hfill\includegraphics{area-defect}
% \end{minipage}
...
\begin{lemm}{}{quadtricorr}
	...
	\begin{minipage}[t]{0.39\linewidth}\vspace{-15pt}
		\hfill\includegraphics[scale=0.95]{area-saccheri4}
	\end{minipage}
\end{lemm}
...
% 		\begin{minipage}[t]{0.39\linewidth}\vspace{-22pt}
			\hfill\includegraphics[scale=0.95]{area-saccheri5}\qedhere
% 		\end{minipage}		
	\end{enumerate}
\end{proof}
...
\begin{proof}
	...
	\begin{minipage}[t]{0.39\linewidth}\vspace{-12pt}
		\hfill\includegraphics{area-saccheri9}\qedhere
	\end{minipage}
\end{proof}
