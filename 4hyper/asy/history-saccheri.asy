...
/*
draw(arc(A,0.2,180*angle(B-A)/pi,180*angle(C-A)/pi),StickIntervalMarker(1,3,Brown));
draw(arc(C,0.2,180*angle(EE-C)/pi,180*angle(A-C)/pi),StickIntervalMarker(1,3,Brown));
...
draw(arc(B,0.2,180*angle(M-B)/pi,180*angle(A-B)/pi),StickIntervalMarker(1,1,lGreen));
draw(arc(EE,0.2,180*angle(M-EE)/pi,180*angle(C-EE)/pi,CCW),StickIntervalMarker(1,1,lGreen));
*/
...
filldraw(B--arc(B,0.3,180*angle(C-B)/pi,180*angle(M-B)/pi)--cycle,BlueViolet);
