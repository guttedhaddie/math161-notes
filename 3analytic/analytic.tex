...
\begin{defn}{}{complexnumbers}
	...
	\hfill\includegraphics[scale=0.9]{complex-argand}
\end{defn}
...
\begin{defn}{}{}
	...
	\hfill\includegraphics{complex-polar}
\end{defn}
...
\begin{example}{}{}
	...
	\begin{minipage}[t]{0.3\linewidth}\vspace{-15pt}
		\hfill\includegraphics{complex-rotate}
	\end{minipage}\medbreak
...
\begin{minipage}[t]{0.26\linewidth}\vspace{-5pt}
		\hfill\includegraphics{complex-reflect}
\end{minipage}
...
\begin{exercises}
	...
	%   \end{enumerate}
		\item Use complex numbers to compute the result of the following transformations: you can answer in either standard or polar form.
	  \begin{enumerate}
