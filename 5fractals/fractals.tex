...
\paragraph{The Length of a Coastline} In 1967 Benoit Mandelbrot asked a related question in a now-famous paper, \emph{How Long Is the Coast of Britain?\ Statistical Self-Similarity and Fractional Dimension.} His essential point was that this question has no simple answer:\footnote{%
...
\begin{example}{}{}
	...
	\begin{minipage}[t]{0.29\linewidth}\vspace{-15pt}
		\hfill\includegraphics{self-sim-circle}
...
\begin{minipage}[t]{0.24\linewidth}\vspace{-12pt}
	\hfill\includegraphics[scale=0.95]{self-sim-line}
\end{minipage}
	...
	\begin{enumerate}\setcounter{enumi}{1}
	  \item[]The contractions $S_1(x)=\frac 13x$ and $S_2(x)=\frac 13x+\frac 23$ (on $\R$) produce a contraction $S:\mathcal H\to\mathcal H$:
		...
		\begin{minipage}[t]{0.45\linewidth}\vspace{-3pt}
			\hfill\includegraphics{cantor-set2}
		\end{minipage}\medbreak
		...
		\begin{minipage}[t]{0.39\linewidth}\vspace{0pt}
			\hfill \href{http://www.math.uci.edu/~ndonalds/math161/koch-anim2.html}{\includegraphics[scale=0.95]{koch3}}
		\end{minipage}\par
		...
		%\begin{minipage}[t]{0.27\linewidth}\vspace{0pt}
			\hfill \href{http://www.math.uci.edu/~ndonalds/math161/sier-anim.html}{\includegraphics[scale=1]{sieranim2}}
		...
		%\hfill
		%\begin{minipage}[t]{0.27\linewidth}\vspace{0pt}
			\hfill \href{http://www.math.uci.edu/~ndonalds/math161/fern-anim.html}{\includegraphics[scale=1]{fern2}}
		%\end{minipage}
	\end{enumerate}
\end{examples}
...
\begin{minipage}[t]{0.19\linewidth}\vspace{0pt}
	\hfill\includegraphics{epsiloncover}
\end{minipage}
...
\begin{minipage}[t]{0.35\linewidth}\vspace{0pt}
	\hfill\includegraphics[scale=0.9]{mandelbrot}
\end{minipage}
