...
\begin{minipage}[t]{0.48\linewidth}\vspace{0pt}
	...
	\paragraph{Axiom of Continuity}\phantom{bob}\smallbreak
	...
	for all $A,B\in\ell$,
	\begin{quote}
		$A*\mathcal O*B$ if and only if $A,B$ lie in distinct subsets $\Sigma_1\setminus\mathcal O$, \ $\Sigma_2\setminus\mathcal O$%, and neither equals $\mathcal O$.
	\end{quote}
	
	
	\paragraph{Playfair's Axiom}\phantom{bob}\smallbreak
