...
\begin{proof}
	...
	\end{itemize}
	Otherwise, suppose $I\neq M$. Then: %The point $A$ is therefore the unique intersection of three distinct lines: $\lin{AB}$, $\lin{AC}$ and $\lin{IM}$. Moreover:
	\begin{itemize}
