...
\begin{proof}
	...
	\begin{enumerate}
		...
		\item $(\delta\not<\gamma)$\lstsp Assume $\mathcolor{mGreen}{\delta<\gamma}$. Transfer $\delta$ to $C$ as shown to obtain $\mathcolor{mGreen}{\eta\cong\delta}$. By the crossbar theorem, we obtain the intersection point $E$. But now $\delta$ is an exterior angle to $\triangle EBC$ congruent to an opposite interior angle $\eta$ of the same triangle, contradicting part 1.
	\end{enumerate}
	\begin{center}
		\tagpdfsetup{table/header-rows={2}}
...
\begin{minipage}[t]{0.62\linewidth}\vspace{0pt}
	...
	This is similar to III.\,1: construct the perpendicular bisectors of two sides as in the picture; necessarily these meet at the center of the required circle.
\end{minipage}
\hfill
