...
\tcblower\flushright\includegraphics{euclid-I1}\hfil\qedsymbol
\end{tcolorbox}
...
\boldsubsubsection{Parallel lines: construction, uniqueness and the angles in a triangle}
...
\begin{thm}[lower separated=false, sidebyside, sidebyside align=top seam, sidebyside gap=0pt, righthand width=0.37\linewidth]{I.\,27}{}
...
\tcblower\flushright\includegraphics[scale=1]{euclid-I27p}\\[-12pt]\hfill\qedsymbol
\end{tcolorbox}
...
\tcblower
\flushright\includegraphics[scale=1]{euclid-I28}
\end{thm}

% \skip\footins=-1.5\bigskipamount
% \footnotetext{Euclid did not quantify angles numerically. This means that $\alpha$ is congruent to some angle \emph{inside} $\delta$.}
\goodbreak
...
\tcblower
\flushright\includegraphics{euclid-I29}\\[-10pt]\qedsymbol
\end{tcolorbox}
...
\flushright\includegraphics{euclid-I32}
\end{minipage}
...
\boldinline{Non-Euclidean Geometry}\phantomsection\label{pg:sphere}

Euclid's proof that the angle sum in a triangle is \ang{180} relies on the parallel postulate. That he waited so long suggests he was trying to establish as much as he could about triangles and basic geometry in its absence. For centuries, many mathematicians assumed such a fundamental fact about triangles must be true independently of the parallel postulate.\smallbreak
...
\flushright\includegraphics[scale=0.95]{euclid-sphere}
\end{minipage}
...
\boldsubsubsection{Playfair's Postulate}
...
\tcblower
\flushright\includegraphics{euclid-playfair-defn}
\end{axiom}
...
\flushright\includegraphics{euclid-playfair3}
...
\end{minipage}\hfill
\begin{minipage}[t]{0.37\linewidth}\vspace{0pt}
\flushright\includegraphics{euclid-playfair2}\\
\flushright\includegraphics{euclid-playfair}
...
\flushright\includegraphics{euclid-I47}
\end{minipage}
...
% \flushright\includegraphics{hilbert-pasch}
% \end{minipage}
...
\flushright\includegraphics{hilbert-interior}
\end{minipage}\bigbreak
...
\tcblower
\flushright\includegraphics{hilbert-pasch2}
\end{thm}
...
\begin{center}
\begin{tabular}{cc}
\includegraphics[scale=0.95]{hilbert-crossbar1}&\includegraphics[scale=0.95]{hilbert-crossbar2}%\\
...
\flushright\includegraphics{hilbert-bisect}
\end{minipage}\medbreak
...
\begin{enumerate}\setcounter{enumi}{1}
  ...
  \flushright\includegraphics[scale=0.9]{hilbert-between}
  \end{minipage}
  ...
  \begin{enumerate}
    ...
    \end{minipage}\hfill\begin{minipage}[t]{0.24\linewidth}\vspace{-25pt}
    	\flushright\includegraphics{hilbert-bernays}
    \end{minipage}
  \end{enumerate}
...
\tcblower
\flushright\includegraphics[scale=0.95]{angles-compare}
\end{defn}
...
\flushright\includegraphics[scale=0.95]{angles-asa}
\end{minipage}
\end{proof}
...
\flushright\includegraphics{angles-isos2}\\[-8pt]
\hfill\qedsymbol
\end{minipage}
\end{tcolorbox}
...
\end{itemize}
\end{minipage}\begin{minipage}[t]{0.3\linewidth}\vspace{0pt}
\flushright\includegraphics{angles-perp}
\end{minipage}\bigbreak
