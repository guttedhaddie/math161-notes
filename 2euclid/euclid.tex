...
\end{itemize}
Despite certain logical issues in Euclid's presentation, his arguments are still worth reading (try Byrne's edition). We'll revisit these basic results in the Exercises and in the next two sections. 
...
\begin{thm}{I.\,16.\ Exterior Angle Theorem}{extangle}
	...
	\begin{minipage}[t]{0.6\linewidth}\vspace{-8pt}
		If one side of a triangle is extended, then the exterior angle is larger than either of the opposite interior angles.\par
	In the picture, $\delta>\alpha$ and $\delta>\beta$.
	\end{minipage}
	\hfill
...
\begin{proof} 
	...
	\begin{enumerate}\itemsep0pt
	  ...
	  \item $\cl{AB}\cong\cl{FB}$ and $\cl{BD}\cong\cl{BC}$ since sides of squares are congruent. Moreover $\angle ABD\cong\angle FBC$ since both contain \textcolor{blue}{$\angle ABC$} and a \textcolor{dkred}{right-angle}.
	  \item Side-angle-side (I.\,4) says that $\triangle ABD$ and $\triangle FBC$ are congruent (identical up to rotation by \ang{90}).
		...
		\begin{align*}
			\operatorname{Area}(\textcolor{dkred}{\square ABFG})&=2\operatorname{Area}(\triangle FBC)\\
			&=2\operatorname{Area}(\triangle ABD)\\
			&=\operatorname{Area}\left(\textcolor{dkred}{\fbox{\phantom{'}}BOLD}\right)\\[-25pt]
		\end{align*}
...
\begin{proof}
	...
	\begin{quote}
		Since $I,M$ lie on the same side of $\smash{\lin{AB}=\lin{BD}}$ as $C$, it follows that $\smash{\cl{IM}}$ does not intersect $\smash{\lin{AB}}$. Since $A,I,M$ are collinear and $A\in\lin{AB}$, we moreover have \textcolor{dkred}{$A\notin\cl{IM}$}.
	\end{quote}
	\begin{center}
		\tagpdfsetup{table/header-rows={2}}
		\begin{tabular}{cc}
	...
	\end{itemize}
	By plane separation, $I,M$ lie on opposite sides of $\lin{AC}$. The collinearity of $A,I,M$ then forces the contradiction \textcolor{dkred}{$A\in\cl{IM}$}.
\end{proof}
