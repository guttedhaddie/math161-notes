...
\begin{proof}
	...
	\begin{quote}
	  P5:\lstsp $\forall$ pairs of lines $\ell,m$ and $\forall$ crossing lines $n$, \  $\beta+\gamma<\ang{180}\implies\ell,m$ \emph{not parallel.}\footnote{Not quite: don't meet on same side. Exercise as to why this forces non-parallel\ldots Let complementary angles be $\beta',\gamma'$, then $\ang{180}<\beta'+\gamma'<\beta+\gamma<\ang{180}$ where middle inequality is because of EATh\ldots}
	\end{quote}
