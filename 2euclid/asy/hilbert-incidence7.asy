...
draw(r*dir(-30)--dir(150),0.7green+0.3black+linewidth(1));
draw(r*dir(90)--dir(270),blue+linewidth(1));
draw(r*dir(210)--dir(30),purple+linewidth(1));
...
ddot((0,0),0.15,blue,0.7green+0.3black,purple);
ddot(dir(30),0.15,red,purple,black);
ddot(dir(150),0.15,orange,0.7green+0.3black,black);
ddot(dir(270),0.15,0.9yellow+0.1black,blue,black);
ddot(dir(30),0.15,red,purple,black);
ddot(r*dir(90),0.15,red,blue,orange);
ddot(r*dir(210),0.15,0.9yellow+0.1black,purple,orange);
ddot(r*dir(-30),0.15,red,0.7green+0.3black,0.9yellow+0.1black);